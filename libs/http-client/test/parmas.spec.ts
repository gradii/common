...
import { HttpParams } from '../src/lib/params';
...
describe('HttpParams', () => {
  ...
  it('should parse an existing url', () => {
    const params = new HttpParams({ fromString: 'a=b&c=d&c=e' });
  ...
  it('should only remove question mark at the beginning of the params', () => {
    const params = new HttpParams({ fromString: '?a=b&c=d&?e=f' });
    expect(params.getAll('a')).toEqual(['b']);
  ...
  it('should allow setting string parameters', () => {
    const params  = new HttpParams({ fromString: 'a=b' });
  ...
  it('should allow appending all string parameters', () => {
    const params  = new HttpParams({ fromString: 'a=a1&b=b1' });
  ...
  it('should allow appending all number parameters', () => {
    const params  = new HttpParams({ fromString: 'a=1&b=b1' });
  ...
  it('should allow appending all boolean parameters', () => {
    const params  = new HttpParams({ fromString: 'a=true&b=b1' });
  ...
  it('should allow deletion of parameters with specific number value', () => {
    const params     = new HttpParams({ fromString: 'a=b&c=1&e=f' });
  ...
  it('should allow deletion of parameters with specific boolean value', () => {
    const params     = new HttpParams({ fromString: 'a=b&c=true&e=f' });
  ...
  it('should allow deletion of one value of a string parameter', () => {
    const params  = new HttpParams({ fromString: 'a=1&a=2&a=3&a=4&a=5' });
  ...
  it('should allow deletion of one value of a number parameter', () => {
    const params  = new HttpParams({ fromString: 'a=0&a=1&a=2&a=3&a=4&a=5' });
  ...
  it('should allow deletion of one value of a boolean parameter', () => {
    const params  = new HttpParams({ fromString: 'a=false&a=true&a=false' });
  ...
  describe('read operations', () => {
    ...
    it('should give an accurate list of keys', () => {
      const params = new HttpParams({ fromString: 'a=1&b=2&c=3&d=4' });
  ...
  describe('encoding', () => {
    it('should encode parameters', () => {
      const params = new HttpParams({ fromString: 'a=standard_chars' });
      expect(params.toString()).toEqual('a=standard_chars');
      const params2 = new HttpParams({ fromString: 'a=1 2 3&b=mail@test&c=3_^[]$&d=eq=1' });
  ...
  describe('toString', () => {
    it('should stringify string params', () => {
      const params = new HttpParams({ fromObject: { a: '', b: '2', c: '3' } });
      expect(params.toString()).toBe('a=&b=2&c=3');
    });
    it('should stringify string array params', () => {
      const params = new HttpParams({ fromObject: { a: '', b: ['21', '22'], c: '3' } });
