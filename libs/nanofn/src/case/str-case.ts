 ...
 */
function _replace(input: string, re: RegExp | RegExp[], value: string) {
...
export function _camelCaseTransform(input: string, index: number) {
  if (index === 0) {
    return input.toLowerCase();
  }
  return _pascalCaseTransform(input, index);
}

export function _camelCaseTransformMerge(input: string, index: number) {
  if (index === 0) {
    return input.toLowerCase();
  }
  return _pascalCaseTransformMerge(input);
}

export function camelCase(input: string, options: Options = {}) {
  return pascalCase(input, {
    transform: _camelCaseTransform,
    ...options
  });
}
...
export function noCase(input: string, options: Options = {}) {
  ...
  const result = _replace(
    _replace(input, splitRegexp, '$1\0$2'),
    stripRegexp,
    '\0'
  );
  let start    = 0;
...
export function _pascalCaseTransform(input: string, index: number) {
...
export function _pascalCaseTransformMerge(input: string) {
...
export function pascalCase(input: string, options: Options = {}) {
  return noCase(input, {
    delimiter: '',
    transform: _pascalCaseTransform,
    ...options
  });
}
...
export function _sentenceCaseTransform(input: string, index: number) {
...
export function sentenceCase(input: string, options: Options = {}) {
  return noCase(input, {
    delimiter: ' ',
    transform: _sentenceCaseTransform,
    ...options
  });
}
