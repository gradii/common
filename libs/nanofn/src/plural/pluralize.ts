...
import {
  defaultIrregularPlurals, defaultIrregularSingles, defaultPluralRules, defaultSingularRules, defaultUncountables
} from '../_internal/_pluralize-values';
 ...
 *
 */
export function _addPluralRule(rule: string | RegExp, replacement: string): void {
 ...
 *
 */
export function _addSingularRule(rule: string | RegExp, replacement: string): void {
 ...
 *
 */
export function _addUncountableRule(word: string | RegExp): void {
  ...
  _addPluralRule(word, '$0');
  _addSingularRule(word, '$0');
}
 ...
 *
 */
export function _addIrregularRule(single: string, plural: string): void {
